...
/**
 * FormUrlEncoded形式の電文を受信して、ログを出力する。
 */
public class ReceiveFormUrlEncodedAction extends MessagingAction {

    /**
     * ロガー。
     */
    private static final Logger LOGGER = LoggerManager.get(ReceiveFormUrlEncodedAction.class);
